...
#Se usa para crear una carpeta
import os
#Se usa para manipular fechas.
import datetime
...
#Recordar: El Xpath puede variar.
...
def parse_home():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Traigo una fecha con la función fecha. Y Today, la fecha del dia de hoy. La variable today
            ...
            #Elevamos el error para ser capturado en el try-except, todo lo que sea un error.
            raise ValueError(f'Error: {response.status_code}')
    except ValueError as ve:
        print(ve)
